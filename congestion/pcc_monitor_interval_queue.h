...
struct PacketRttSample {
  PacketRttSample();
#ifdef QUIC_PORT
  PacketRttSample(QuicPacketNumber packet_number, TimeDelta rtt);
#else
  PacketRttSample(QuicPacketNumber packet_number, ProtoTime rtt);
#endif
  ~PacketRttSample() {}
...
#ifdef QUIC_PORT
  TimeDelta sample_rtt;
#else
  ProtoTime sample_rtt;
#endif
};
