...
class PccSender
 ...
 public:
...
#ifdef QUIC_PORT
  PccSender(ProtoTime now,const RttStats* rtt_stats,
            const UnackedPacketMap* unacked_packets,
            QuicPacketCount initial_congestion_window,
            QuicPacketCount max_congestion_window, Random* random);
#else
  PccSender(ProtoTime initial_rtt_us,
            QuicPacketCount initial_congestion_window,
  ...
  void SetInitialCongestionWindowInPackets(PacketCount packets) override{}
#endif
  ...
  TimeDelta ComputeMonitorDuration(
      QuicBandwidth sending_rate,
      TimeDelta rtt);
#else
  ProtoTime ComputeMonitorDuration(
      QuicBandwidth sending_rate,
      ProtoTime rtt);
#endif
